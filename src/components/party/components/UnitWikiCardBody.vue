      ...
      <div style="display: flex; width: 100%; margin: 16px 16px 0;">
        <div style="position: absolute; z-index: 1;">
          ...
          <el-image
              ...
              top: calc(75px);
            "
              :src="'/assets/worldflipper/unit/pixelart/walk_front/' + unit['extraction_id'] + '.gif'"
              alt=""
          />
        </div>
        <UnitPicOrigin :unit="unit" :size="120" :awakened="show_awakened"/>
        <div style="display: flex; width: 744px; justify-content: space-between;">
          <div style="padding: 8px 16px; font-size: 20px;">
            ...
            <p style="font-size: 34px; font-family: '华文细黑', serif; font-weight: 600;">
              ...
              <!--                /*user-select: none;*/-->
              <!--              "-->
              <!--                :src="'/assets/worldflipper/icon/' + getElementCss(unit['element']) + '.png'"-->
              <!--                alt=""-->
              <!--                @dragstart.prevent-->
              <!--            />-->
              {{ unit['name'][0] }}
            ...
            <div style="display: flex; font-size: 16px; justify-content: space-evenly; flex-direction: row;">
              <div style="width: 165px;">
                <div class="span-f">
                  ...
                  {{ unit['status']['mhp'] }} <span style="color: crimson;">({{ unit['status']['mmhp'] }})</span>
                </div>
                <div class="span-f">
                  <div class="span-tag">ATK</div>
                  {{ unit['status']['atk'] }} <span style="color: crimson;">({{ unit['status']['matk'] }})</span>
                </div>
              </div>
              <div style="width: 165px;">
                <div class="span-f">
                  <div class="span-tag">类型</div>
                  {{ type2zh[unit['pf_type']] }}
                </div>
                <div class="span-f">
                  <div class="span-tag">种族</div>
                  {{
                    format_race(unit['race']).join(' / ')
                  }}
                </div>
              </div>
              <div style="width: 165px;">
                <div class="span-f">
                  ...
                  {{ gender2zh[unit['gender']] }}
                </div>
                <div class="span-f">
                  <div class="span-tag">CV</div>
                  {{ unit['cv'] === '(None)' ? '无' : unit['cv'] }}
                </div>
              </div>
            </div>
        ...
        <div style="display: flex; width: 100%; margin: 16px 16px 0;">
          ...
          <div style="display: flex; flex-direction: column;">
            <div class="span-ability" style="padding-bottom: 4px;">
              <div style="margin: 0 8px; font-weight: 600; font-size: 22px;" v-html="format_content(unit['leader_ability_name'])"/>
            </div>
            <div class="span-ability" style="padding-bottom: 4px;">
              <!--          <div style="color: rgb(47, 195, 183); font-size: 20px;">❶</div>-->
              <div style="margin: 0 8px;" v-html="format_content(unit['leader_ability'])"/>
            </div>
          </div>
        </div>
        <div style="display: flex; width: 100%; margin: 16px 16px 0;">
          ...
          <div style="display: flex; flex-direction: column;">
            <div class="span-ability" style="padding-bottom: 4px;">
              <div style="margin: 0 8px; font-weight: 600; font-size: 22px;" v-html="format_content(unit['skill_name'])"/>
            </div>
            <div class="span-ability" style="padding-bottom: 4px;">
              <div style="margin: 0 8px;" v-html="format_content(unit['skill_description'])"/>
            </div>
            <div class="span-ability" style="padding-bottom: 4px;">
              <div style="margin: 0 8px;">
                技能能量：{{ unit['skill_weight'] }}
              </div>
            </div>
          </div>
        </div>
        <div style="display: flex; width: 100%; margin: 16px 16px 0;">
          ...
          <div style="display: flex; flex-direction: column;">
            <div class="span-ability">
              <div style="color: rgb(47, 195, 183); font-size: 20px;">❶</div>
              <div style="margin: 0 8px;" v-html="format_content(unit['ability1'])"/>
            </div>
            <div class="span-ability">
              <div style="color: rgb(47, 195, 183); font-size: 20px;">❷</div>
              <div style="margin: 0 8px;" v-html="format_content(unit['ability2'])"/>
            </div>
            <div class="span-ability">
              <div style="color: rgb(47, 195, 183); font-size: 20px;">❸</div>
              <div v-if="unit['ability3']" style="margin: 0 8px;"  v-html="format_content(unit['ability3'])"/>
              <div v-else style="margin: 0 8px;">--</div>
            </div>
            <div v-if="unit.hasOwnProperty('ability4') && unit['ability4']" class="span-ability">
              <div style="color: rgb(47, 195, 183); font-size: 20px;">❹</div>
              <div style="margin: 0 8px; opacity: 0.55;" v-html="format_content(unit['ability4'])"/>
            </div>
            <div v-if="unit.hasOwnProperty('ability5') && unit['ability5']" class="span-ability">
              <div style="color: rgb(47, 195, 183); font-size: 20px;">❺</div>
              <div style="margin: 0 8px; opacity: 0.55;" v-html="format_content(unit['ability5'])"/>
            </div>
            <div v-if="unit.hasOwnProperty('ability6') && unit['ability6']" class="span-ability">
              <div style="color: rgb(47, 195, 183); font-size: 20px;">❻</div>
              <div style="margin: 0 8px; opacity: 0.55;" v-html="format_content(unit['ability6'])"/>
            </div>
          </div>
        </div>
      </div>
