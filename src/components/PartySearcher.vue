...
<!--      {{ party_releases }}-->
<!--    </div>-->
    <el-scrollbar ref="scrollbar_ref" style="z-index: 2;">
      <div style="display: flex; flex-wrap: wrap; justify-content: center;">
        <el-card class="party-card" v-for="(p, id) in party_releases" body-style="padding: 12px 8px 8px;" style="margin: 8px; width: fit-content">
